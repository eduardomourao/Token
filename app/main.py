...
from app.modules.antigravity_usage import api as antigravity_usage_api
from app.modules.antigravity_usage.scheduler import build_antigravity_usage_scheduler
...
from app.modules.gemini_usage import api as gemini_usage_api
from app.modules.gemini_usage.scheduler import build_gemini_usage_scheduler
from app.modules.health import api as health_api
from app.modules.model_sources import api as model_sources_api
from app.modules.oauth import api as oauth_api
from app.modules.opencode_go_usage import api as opencode_go_usage_api
from app.modules.opencode_go_usage.scheduler import build_opencode_go_usage_scheduler
...
async def lifespan(app: FastAPI):
    ...
    opencode_go_usage_scheduler = build_opencode_go_usage_scheduler()
    gemini_usage_scheduler = build_gemini_usage_scheduler()
    antigravity_usage_scheduler = build_antigravity_usage_scheduler()
    ...
    await opencode_go_usage_scheduler.start()
    await gemini_usage_scheduler.start()
    await antigravity_usage_scheduler.start()
    ...
    try:
        ...
        await opencode_go_usage_scheduler.stop()
        await gemini_usage_scheduler.stop()
        await antigravity_usage_scheduler.stop()
...
def create_app() -> FastAPI:
    ...
    app.include_router(opencode_go_usage_api.router)
    app.include_router(gemini_usage_api.router)
    app.include_router(antigravity_usage_api.router)
