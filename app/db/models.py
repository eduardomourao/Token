...
class OpenCodeGoUsageMonitor(Base):
    """Singleton encrypted credential and refresh state for OpenCode Go telemetry."""

    __tablename__ = "opencode_go_usage_monitor"
...
class OpenCodeGoUsageSample(Base):
    __tablename__ = "opencode_go_usage_samples"
    ...
    __table_args__ = (
        ...
        Index("ix_opencode_go_usage_samples_window_captured", "window", "captured_at"),
    )


class GeminiUsageMonitor(Base):
    __tablename__ = "gemini_usage_monitor"
...
class GeminiUsageSample(Base):
    __tablename__ = "gemini_usage_sample"
    ...
    __table_args__ = (
        ...
        Index("ix_gemini_usage_sample_window_captured", "window", "captured_at"),
    )


class AntigravityUsageMonitor(Base):
    __tablename__ = "antigravity_usage_monitor"
...
class AntigravityUsageSample(Base):
    __tablename__ = "antigravity_usage_sample"
    ...
    __table_args__ = (
        ...
        Index("ix_antigravity_usage_sample_group_captured", "group", "captured_at"),
    )
