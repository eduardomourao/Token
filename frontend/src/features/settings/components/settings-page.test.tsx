...
const openCodeGoUsageSettingsMock = vi.fn();
...
vi.mock("@/features/opencode-go-usage/components/opencode-go-usage-settings", () => ({
  OpenCodeGoUsageSettings: (props: unknown) => {
    openCodeGoUsageSettingsMock(props);
    return <div>OpenCode Go Usage Settings</div>;
  },
}));
...
describe("SettingsPage", () => {
  ...
  beforeEach(() => {
    ...
    openCodeGoUsageSettingsMock.mockReset();
  });
